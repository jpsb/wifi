...
ActiveSupport::Inflector.inflections do |inflect|
  ...
  inflect.irregular 'tipo_movimento', 'tipos_movimentos'
  inflect.irregular 'tipo_evento', 'tipos_eventos'
  inflect.irregular 'tipo_especialidade', 'tipo_especialidades'
  inflect.irregular 'especialidade_regulavel', 'especialidades_regulaveis'
  inflect.irregular 'estabelecimento_profissional', 'estabelecimentos_profissionais'
  inflect.irregular 'motivo_encerramento_samu', 'motivos_encerramentos_samu'
